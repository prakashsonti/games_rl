...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      <div className="max-w-2xl w-full bg-slate-800/60 backdrop-blur rounded-2xl p-4 sm:p-6 shadow-2xl border border-slate-700">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-bold text-slate-100">Connect 4 RL</h1>
        ...
        <div className="flex items-center justify-between mt-4 gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={resetGame}
              className="px-3 py-1 text-sm rounded-lg bg-slate-700 hover:bg-slate-600 transition-colors border border-slate-600"
            >
              Reset
            </button>
          </div>
